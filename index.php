...
<body>
    ...
    <div class="display-info">
            ...
            echo "<table border='1' cellspacing='0'>";
            echo "<tr><th>STT</th><th>Mã công dân</th><th>Tên công dân</th><th>Giới tính</th><th>Năm sinh</th><th>Nước về</th></tr>";
            $stt = 1;
            $displaygioitinh = '';
            if ($ketquahienthicongdan->num_rows > 0) {
                while ($row = $ketquahienthicongdan->fetch_row()) {
                    if($row[2] == 1) {
                        $displaygioitinh = "Nam";
                    } else $displaygioitinh = "Nữ";
                    echo "<tr>";
                    echo "<td>$stt</td><td>$row[0]</td><td>$row[1]</td><td>$displaygioitinh</td><td>$row[3]</td><td>$row[4]</td>";
                    echo "</tr>";
                    $stt++;
                }
            } else {
